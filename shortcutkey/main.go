...
import (
	"fmt"
	"github.com/github-123456/gostudy/messagehook"
	"unsafe"
)
...
var keys = []int{}
func main() {messagehook.Start(func(i int, wparam messagehook.WPARAM, lparam messagehook.LPARAM) messagehook.LRESULT {
